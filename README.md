...
- The dataset is historical and should not be interpreted as live 2026 health surveillance.
- Different indicators cover different time ranges.
- Some indicators contain missing values.
- The data is country-level rather than patient-, hospital- or rural/urban-level.
- The hackathon priority score is an analytical model, not an official public-health ranking.
...
- [ADHCRI full case study](https://mayfuns.github.io/mariam-analytics-portfolio/adhcri.html)
